...
@interface ScreenshotDetectApi ()
@property(nonatomic, strong) NSObject<FlutterBinaryMessenger> *binaryMessenger;
@property(nonatomic, strong) NSString *messageChannelSuffix;
@end

@implementation ScreenshotDetectApi
...
- (void)didTakeScreenshotWithCompletion:(void (^)(FlutterError *_Nullable))completion {
  NSString *channelName = [NSString stringWithFormat:@"%@%@", @"dev.flutter.pigeon.screenshot_detect.ScreenshotDetectApi.didTakeScreenshot", _messageChannelSuffix];
